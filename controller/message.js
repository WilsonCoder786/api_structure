...
exports.sendMessage = async (req, res, next) => {
    ...
    try {
        ...
        if (message) {
            ...
            console.log(channel)
            await sendMessage({ senderObject, receiverIds, type, relatedId:channel, relatedType:"message" });
...
exports.getMessages = async (req, res, next) => {
    ...
    try {
        ...
        let messagesData = await findMessages({ query, page, limit, populate: 'sender parent' });
...
exports.getChatList = async (req, res, next) => {
    ...
    try {
        const chats = await findChats({ query, page, limit });
