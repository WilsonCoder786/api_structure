...
const { getMongoosePaginatedData, sendNotificationToAll, getMongooseAggregatePaginatedData } = require("../utils");
...
exports.createAndSendNotification = async ({ senderObject, receiverIds, type, competition, sourceId, relatedId, relatedType, Image }) => {
    ...
    switch (type) {
        ...
        case NOTIFICATION_TYPE.COMPETITION_WINNER:
            console.log('this is the suggestion of shafqat',senderObject?.fullName)
